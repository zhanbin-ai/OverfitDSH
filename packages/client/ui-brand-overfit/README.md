...
- **The hero copy is product copy** — `hero.headline` reads 虚拟即现实 ("Virtual is real"); beneath it ship two English lines from the same dictionaries: the motto “Creature Imitates Creator” (`hero.subheadline`) and its dimmed annotation “Artificial intelligence evolves toward humankind, and humankind imitates its Creator.” (`hero.annotation`) — none of them comes from this package.
