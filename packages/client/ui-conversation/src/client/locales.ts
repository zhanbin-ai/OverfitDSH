...
export const zh = {
  ...
  'hero.headline': '虚拟即现实',
  'hero.subheadline': 'Creature Imitates Creator',
  'hero.annotation': 'Artificial intelligence evolves toward humankind, and humankind imitates its Creator.',
  'hero.preview': '预览版',
