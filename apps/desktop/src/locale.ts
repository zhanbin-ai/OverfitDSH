...
export const en = {
  ...
  startupFailed: 'Overfit is unavailable',
  ...
  updateDownloadedTitle: 'Overfit v{version} downloaded',
...
export const zh = {
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: '拟合 v{version} 下载完成',
